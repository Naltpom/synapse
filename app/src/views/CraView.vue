  ...
  <div>
    ...
    <div class="mb-5 flex flex-wrap items-center gap-3">
      <select
        ...
        class="rounded-md border border-ink/12 bg-white px-3 py-1.5 text-[13px] focus:border-primary"
      >
        <option v-for="c in consultants" :key="c.id" :value="c.id">{{ c.fullName }}</option>
      </select>

      <div class="flex items-center gap-1 rounded-md border border-ink/10 bg-white p-1">
    ...
    <!-- Grille -->
    <div v-if="grid" class="overflow-hidden rounded-lg border border-ink/8 bg-white">
